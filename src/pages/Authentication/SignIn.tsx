        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              "Potencia tu éxito con Smart Tech: Datos, Tecnología, Resultados"
              </p>
              ...
              <form>
                ...
                <div className="mb-5">
                  <input
                    ...
                    className="w-full cursor-pointer rounded-lg border border-warning bg-warning p-4 text-white font-bold transition hover:bg-opacity-90"
                  />
                </div>
