          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block" src="../public/logo.png" alt="Logo" />
                <img className="dark:hidden" src="../public/logo.png" alt="Logo" />
              </Link>
              <p className="2xl:px-20">
                "Potencia tu éxito con Smart Tech: Datos, Tecnología,
                Resultados"
              </p>
              ...
              <span className="mt-15 inline-block">
                ...
                >
                  ...
                  />
                  <path
                    d="M203.062 278.617H170.68C170.121 278.617 169.584 278.394 169.189 277.999C168.793 277.604 168.571 277.068 168.57 276.509V265.168C168.571 264.609 168.793 264.073 169.189 263.678C169.584 263.283 170.121 263.06 170.68 263.06H203.062C203.621 263.06 204.158 263.283 204.553 263.678C204.949 264.073 205.171 264.609 205.172 265.168V276.509C205.171 277.068 204.949277.604 204.553 277.999C204.158 278.394 203.621 278.617 203.062 278.617Z"
                    fill="#FFA500"
                  />
                  <path
              ...
              <form>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Crear cuenta"
                    className="w-full cursor-pointer rounded-lg border border-warning bg-warning p-4 font-bold text-white transition hover:bg-opacity-90"
                  />
                </div>
